...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className="flex min-h-[100svh] flex-col bg-white text-gray-800 antialiased selection:bg-primary-500/30 dark:bg-gray-900 dark:text-gray-100 lg:grid lg:grid-cols-[300px_1fr] lg:grid-rows-[1fr_auto]">
        <Header />
