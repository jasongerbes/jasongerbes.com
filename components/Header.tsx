...
export function Header() {
  ...
  return (
    <header className="sticky top-0 border-b border-primary-600/10 bg-primary-50/50 backdrop-blur-xl dark:border-gray-800 dark:bg-primary-900/10 lg:static lg:row-span-2 lg:border-b-0 lg:border-r lg:backdrop-blur-none">
