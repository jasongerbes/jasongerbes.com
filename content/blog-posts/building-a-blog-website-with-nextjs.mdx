...
<p className="lead">
  ...
  personal project: replacing my outdated Jekyll website with a modern Next.js
  blog. In this post, I'll guide you through building a bleeding-edge blog using
