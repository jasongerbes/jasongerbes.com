...
export function Codeblock({ children, ...props }: CodeblockProps) {
  ...
  return (
    <>
      ...
      <CopyButton
        className="absolute right-2.5 top-[9px] opacity-0 transition-opacity focus:opacity-100 lg:right-[13px] lg:top-[13px] [[data-rehype-pretty-code-title]~&]:top-[58px] [div:hover>&]:opacity-100"
        elementRef={ref}
        data-theme={theme}
      />
    </>
